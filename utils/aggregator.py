...
def extract(dpath, subpath):
    ...
    scalar_accumulators = [EventAccumulator(str(dpath / subpath)).Reload(
...
if __name__ == '__main__':
    ...
    parser.add_argument("--path", type=str, help="main path for tensorboard files", default=os.getcwd()+PATHONE)
